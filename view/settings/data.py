...
class Datos():
    ...
    def confrmar_eliminar(self):
        ...
        ttk.Button(confirmar, text='Cancelar', command=lambda: confirmar.destroy()).grid(
            row=2, column=0, padx=10, pady=10, sticky='e')
        ttk.Button(confirmar, text='Confirmar', command=lambda: eliminar_db(
            confirmar)).grid(row=2, column=1, padx=10, pady=10, sticky='w')
